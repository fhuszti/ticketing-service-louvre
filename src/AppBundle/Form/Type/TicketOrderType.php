...
class TicketOrderType extends AbstractType
{
        ...
        switch ($options['flow_step']) {
            case 1:
                $builder->add('date',      DateType::class, array(
                            'invalid_message' => "core.ticket_order_type.date.message",
                            'widget' =>          'single_text',
                            'html5' =>           false,
                            'label' =>           "core.ticket_order_type.date.label",
                        ...
                        ->add('type',      ChoiceType::class, array(
                            ...
                            'choices' =>   array(
                                ...
                                'core.ticket_order_type.type.choice.full' => true
                            ),
                            'expanded' =>        true,
                            'multiple' =>        false,
                            'translation_domain' => 'validators'
                        ...
                        ->add('nbTickets', IntegerType::class, array(
                            'invalid_message' => "core.ticket_order_type.count.message",
                            'label' =>           "core.ticket_order_type.count.label",
                            'attr' =>      array('min' => 1),
                            'translation_domain' => 'validators'
                        ));
                break;
            case 2:
                ...
                //to remember the price for display in step 3, will be populated with jquery
                        ->add('price', IntegerType::class, array(
                            'invalid_message' => "core.ticket_order_type.price.message",
                            'label_attr' => array('class' => 'hidden-label'),
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\TicketOrder',
